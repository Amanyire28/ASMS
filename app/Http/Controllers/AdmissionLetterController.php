...
{
    /**
     * Get all required school settings for admission letters
     */
    private function getSchoolSettings()
    {
        return [
            ...
            'admission_letter_opening' => SchoolSetting::get('admission_letter_opening'),
            'admission_letter_requirements' => SchoolSetting::get('admission_letter_requirements'),
            'admission_letter_closing' => SchoolSetting::get('admission_letter_closing'),
            'admission_letter_contact_info' => SchoolSetting::get('admission_letter_contact_info'),
        ];
    }
