...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow">
    <form action="{{ route('students.update', $student) }}" method="POST" enctype="multipart/form-data" class="p-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-sm text-gray-600 dark:text-gray-400 mb-4">Update admission details and status</p>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <!-- Admitted Checkbox -->
                <div class="md:col-span-2">
                    <label class="flex items-center">
                        <input type="checkbox" name="is_admitted" value="1" {{ old('is_admitted', $student->is_admitted) ? 'checked' : '' }}
