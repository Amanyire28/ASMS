            ...
            <div class="flex items-stretch gap-0 bg-gray-50 rounded-lg border border-gray-200 overflow-hidden flex-nowrap">
                ...
                <div class="flex-none flex flex-col items-center justify-center px-5 py-3 min-w-[92px]">
                    @if($report->student->photo)
                        <img src="{{ asset('storage/' . $report->student->photo) }}" alt="Student Photo" class="h-24 w-20 object-cover rounded border-2 border-gray-300 shadow-sm">
                    @else
            ...
            <div class="grid grid-cols-2 gap-8 pt-4 border-t border-gray-200">
                <div class="text-center">
                    @if(school_signature_url('principal'))
                        <img src="{{ school_signature_url('principal') }}" alt="Principal Signature" class="h-14 mx-auto object-contain mb-2">
                    @else
                ...
                <div class="text-center">
                    @if(school_signature_url('headteacher'))
                        <img src="{{ school_signature_url('headteacher') }}" alt="Head Teacher Signature" class="h-14 mx-auto object-contain mb-2">
                    @else
                        <div class="h-14 mb-2 border-b-2 border-gray-400 mx-8"></div>
                    @endif
